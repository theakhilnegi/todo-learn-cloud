  ...
  return (
    <div className="list-container">
      ...
      <div className="status">
        {selectedButton === "all" && <span>{allCounter} items total</span>}
        ...
        {isLarge && (
          <div className="filter-large">
            <button
              ...
              className={selectedButton === "all" ? "active-filter" : ""}
            >
              All
            </button>
            <button
              onClick={() => handleButtonClick("active")}
              className={selectedButton === "active" ? "active-filter" : ""}
            >
              Active
            </button>
            <button
              onClick={() => handleButtonClick("completed")}
              className={selectedButton === "completed" ? "active-filter" : ""}
            >
              Completed
            </button>
          </div>
